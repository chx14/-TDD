...
class NewVisitorTest(unittest.TestCase):  #(1)
    ...
    def test_can_start_a_list_and_retrieve_is_later(self): #(2)
...
# thar he site has generated a unique URL for her -- there is some
# explanatory text to that effect.

# She visit thar URL - her to-do list is still there
